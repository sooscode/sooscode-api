...
public enum ErrorCode {
    ...
    // ===== ASSIGNMENT =====
    ASSIGNMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "ASSIGNMENT_001", "담당 강사를 찾을 수 없습니다."),
    ASSIGNMENT_ALREADY_EXISTS(HttpStatus.FORBIDDEN, "ASSIGNMENT_002", "담당 강사가 이미 존재합니다.");
